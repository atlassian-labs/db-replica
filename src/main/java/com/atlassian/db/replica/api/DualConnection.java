...
public class DualConnection implements Connection {
    ...
    public PreparedStatement prepareStatement(String sql) throws SQLException {
        return ReplicaPreparedStatement.builder(connectionProvider, consistency, sql).build();
    }
    ...
    public void setAutoCommit(boolean autoCommit) throws SQLException {
        connectionProvider.getWriteConnection().setAutoCommit(autoCommit);
    }

    @Override
    public boolean getAutoCommit() throws SQLException {
        return connectionProvider.getCurrent().getAutoCommit();
    }

    @Override
    public void commit() throws SQLException {
        connectionProvider.getCurrent().commit();
    }

    @Override
    public void rollback() throws SQLException {
        connectionProvider.getCurrent().rollback();
    }
    ...
    public boolean isClosed() throws SQLException {
        return connectionProvider.getCurrent().isClosed();
    }
    ...
    public void setTransactionIsolation(int level) throws SQLException {
        connectionProvider.getWriteConnection().setTransactionIsolation(level);
    }
    ...
    public PreparedStatement prepareStatement(
        ...
        return ReplicaPreparedStatement.builder(
            connectionProvider,
            consistency,
            sql
        ).resultSetType(resultSetType)
